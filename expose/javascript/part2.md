...
9. Error; Before line 11 runs, line 8 tries to add a value to the const "discounted", which can't happen as to a const.
10. Error; Before line 11 runs, line 8 tries to add a value to the const "discounted", which can't happen as to a const.
11. Error; Before line 11 runs, line 8 tries to add a value to the const "discounted", which can't happen as to a const.  
